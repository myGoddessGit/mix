 ...
 * @date 2020/11/13
 */
open class TagTextView @JvmOverloads constructor(context: Context, attrs : AttributeSet? = null, defStyleAttr : Int = 0)
        ...
        tagText?.takeIf { it.isNotEmpty() }?.let { text ->
            textPaint.apply {
                ...
                fontMetricsInt.let {
                    ...
                    val radius = if (bgWidth > bgHeight) bgHeight / 2 else bgHeight / 2
