...
public class LoadingView extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        // 判断外圆的半径
        mOuterCircleRadius = (int) (Math.min(mOuterCircleRadius, (Math.min(w - getPaddingRight() - getPaddingLeft(), h - getPaddingTop() - getPaddingBottom()) - 4 * mPaint.getStrokeWidth()) / 2));
        ...
        mPath.moveTo(centerX - (mInnerTriangleRadius / 2), (float) (centerX - Math.sqrt(3) * mInnerTriangleRadius / 2));
...
//    public static class Test<T> extends Handler {
